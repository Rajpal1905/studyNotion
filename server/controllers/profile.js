...
exports.updateProfile = async( req, res) =>{
    try {
        ...
        return res.status(200).json({
            success:true,
            msg:"Profile Updated Successully",
            profileDetail
        })
        ...
        return res.status(500).json({
            success:false,
            msg:"Error occurred while updating the profile"
...
exports.updateDisplayPicture = async (req, res) => {
    try {
      ...
      const userId = req.user.id
      const image = await imageUploadToCloundinary(
        displayPicture,
  ...
  exports.getAllUserDetails = async (req, res) => {
    try {
      ...
      console.log(userDetails);  // Check userDetails structure
